...
namespace CajasDeDialogo
{
    public partial class Form1 : Form
    {
        ...
        private void dialogoCasillaDeVerificacionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DlgCasillaVerificacion Dlg = new DlgCasillaVerificacion();
            Dlg.ShowDialog();
        }

        private void botónDeOpciónToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void listaDesplegableToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DlgListaDesplegable Dlg = new DlgListaDesplegable();
            Dlg.ShowDialog();
        }

        private void controlConPestañasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DlgControlConPestañas Dlg = new DlgControlConPestañas();
            Dlg.ShowDialog();
        }

        private void gestionDeFechasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DlgGestionFechas Dlg = new DlgGestionFechas();
            Dlg.ShowDialog();
        }

        private void panelDeDiseñoToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ArchivoColor_Click(object sender, EventArgs e)
        {
        ...
        private void ArchivoFuente_Click(object sender, EventArgs e)
        {
